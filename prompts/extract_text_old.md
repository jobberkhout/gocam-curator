...
Extract only what the text explicitly states but you must be completely exhaustive and extract EVERY interaction even if minor, implicit or secondary. Do not summarize. Do not infer, speculate, or add information that is not present in the source material.
